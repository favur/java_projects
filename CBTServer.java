 ...
 */
package cbtsystemserverversion;
//
...
//import java.awt.ComboBoxRenderer;
...
//
public class CBTSystemServerVersion extends JFrame {
    static CBTSystemServerVersion resWizard = null;
    //
    static String getPasswordForCode = "GreeT52_38ServerS38_52";
    static reQuestionDialog reQuest = null;
    //
    ...
    class callHomePage {
        ...
        public callHomePage() {
            //
            if (getNumberOfDetails("select * from user") == 0) {
                insertUpdateDelete("insert into user "
                        + "values ('admin', 'admin', 'admin')");
                insertUpdateDelete("insert into user "
                        + "values ('password', 'student', 'student')");
            }
            //
            ...
            //
            if (getSchoolName.equalsIgnoreCase("nil")
                    || getSchoolAddress.equalsIgnoreCase("nil")) {
                loginDepartmentNameLab = new JLabel("Schools' Profile Not Created.");
                //
                getSchoolName = (getSchoolName.equalsIgnoreCase("nil") ? 
                            "" : getSchoolName).toUpperCase();
                //
                getSchoolName = "SCHOOL NAME NOT SET";
                getSchoolAddress = "SCHOOL ADDRESS NOT SET";
            } 
            else {
                loginDepartmentNameLab = new JLabel(getSchoolName.toUpperCase());
            }
            //
            ...
            //
            loginDepartmentNameLabPanel.removeAll();
            loginDepartmentNameLabPanel.add(loginDepartmentNameLab);
            //
            loginComponentsPanel.removeAll();
            ...
            //
            loginComponentsLeftPanel.removeAll();
    ...
    class administrativeHomePage {
        ...
        class cbTestingSetupPanel extends JPanel {
            ...
            class newTestControl extends MouseAdapter {
                ...
                public void mouseClicked(MouseEvent e) {
                    ...
                    formPanel.setBorder(
                            BorderFactory.createTitledBorder(null,
                            " Test Parameter Schedule Section ",
                            TitledBorder.LEFT, 0, new Font(getFontType, Font.BOLD, 10), 
                            Color.BLUE));
                    //
                    ct = 0;
        ...
        class welcomePanel extends JPanel {
            ...
            schoolConfigPage schoolPage = null;
            //
            public welcomePanel() {
                ...
                //
                centerPanel.setLayout(new BorderLayout());
                if(schoolNameLab.getText().equalsIgnoreCase("school name not set")) {
                    schoolNameAddressPanel.setLayout(new GridLayout(5, 1, 5, 5));
                    //
                    schoolNameAddressPanel.add(schoolNameLab);
                    schoolNameAddressPanel.add(schoolAddressLab);
                    schoolNameAddressPanel.add(new JLabel(""));
                    schoolNameAddressPanel.add(new JLabel(""));
                    schoolNameAddressPanel.add(new JLabel(""));
                    //
                    centerPanel.add(schoolNameAddressPanel, BorderLayout.SOUTH);
                }
                else {
                ...
                validate();
                //
                if (getOneDetail("select schoolname from schoolprofile").equalsIgnoreCase("nil")) {
                    schoolNameLab.setCursor(Cursor.getPredefinedCursor(Cursor.HAND_CURSOR));
                    schoolNameLab.setToolTipText("Click to Create School Name");
                    schoolNameLab.addMouseListener(new getSchoolNameControl());
                }
            }
            //
            class getSchoolNameControl extends MouseAdapter {

                public void mouseClicked(MouseEvent e) {
                    schoolPage = new schoolConfigPage();
                    schoolPage.setSize(350, 450);
                    schoolPage.setTitle("Create School Profile");
                    Dimension frame = schoolPage.getToolkit().getScreenSize();
                    int height = schoolPage.getHeight(),
                            width = schoolPage.getWidth();
                    schoolPage.setLocation(
                            (frame.width - width) * 3 / 6,
                            (frame.height - height) / 2);
                    schoolPage.setVisible(true); 
                }
            }
            //
            class schoolConfigPage extends JDialog {
                //
                JLabel schoolNameLab = new JLabel(" Enter School Name"), 
                        schoolAddressLab = new JLabel(" Enter School Address");
                JTextField schoolNameField = new JTextField(20),
                        schoolAddressField = new JTextField(20);
                //
                JButton serverButton = new JButton("Create Profile");
                //
                public schoolConfigPage() {
                    //
                    JPanel serverSouthPanel = new JPanel(),
                            serverNorthPanel = new JPanel();
                    //
                    ...
                    serverNorthPanel.add(new JLabel(
                            new ImageIcon("images/serverlogo.jpg")));
                    //
                    schoolNameLab.setFont(new Font(getFontType, Font.PLAIN, 14));
                    schoolNameLab.setForeground(Color.BLUE);
                    schoolAddressLab.setFont(new Font(getFontType, Font.PLAIN, 14));
                    schoolAddressLab.setForeground(Color.BLUE);
                    schoolNameField.setFont(new Font(getFontType, Font.PLAIN, 14));
                    schoolNameField.setForeground(Color.BLACK);
                    schoolNameField.setBorder(BorderFactory.createEtchedBorder());
                    schoolAddressField.setFont(new Font(getFontType, Font.PLAIN, 14));
                    schoolAddressField.setForeground(Color.BLACK);
                    schoolAddressField.setBorder(BorderFactory.createEtchedBorder());
                    serverButton.setFont(new Font(getFontType, Font.BOLD, 10));
                    serverButton.setForeground(Color.RED);
                    serverButton.setBackground(Color.WHITE);
                    //
                    ...
                    //
                    serverSouthPanel.setBackground(Color.WHITE);
                    serverSouthPanel.setLayout(new GridLayout(5, 1, 0, 1));
                    serverSouthPanel.add(schoolNameLab);
                    serverSouthPanel.add(schoolNameField);
                    serverSouthPanel.add(schoolAddressLab);
                    serverSouthPanel.add(schoolAddressField);
                    serverSouthPanel.add(serverButtonPanel);
                    //
                    setBackground(Color.WHITE);
                    setLayout(new BorderLayout());
                ...
                class configServerControl implements ActionListener {
                    ...
                    public void actionPerformed(ActionEvent e) {
                        //
                        getSchoolName = schoolNameField.getText();
                        getSchoolAddress = schoolAddressField.getText();
                        //
                        JTextArea msg = new JTextArea("***** PREVIEW MESSAGE *****\n"
                                + "      SCHOOL NAME: " + getSchoolName.toUpperCase() + "\n"
                                + "SCHOOL ADDRESS: " + getSchoolAddress.toUpperCase() + "\n"
                                + "***** PREVIEW MESSAGE *****\n\n"
                                + "Do You Want To Save Preview?", 4, 30);
                        //
                        msg.setLineWrap(true);
                        msg.setWrapStyleWord(true);
                        msg.setEditable(false);
                        ...
                        //
                        if (reply == JOptionPane.YES_OPTION) {
                            insertUpdateDelete("update schoolprofile "
                                + "set schoolname = '" + getSchoolName.toLowerCase() + "', "
                                    + "schooladdress = '" + getSchoolAddress.toLowerCase() + "'");
                            //
                            aniText = " (c)Powered By OrionSoftech For "
                                     + getSchoolName.toUpperCase() + " ";
                            schoolPage.setVisible(false);
                        } 
                    }
                }
            }
    ...
    //
    static String[] pinList = {"2898-2370", "0803-8832", "8783-8239", "2872-3872",
                                "0823-7082", "8082-3339", "7782-0802", "8802-2389",
                                "7923-6734", "9823-9892", "8823-0923", "7238-9803",
                                "7228-9898", "0073-8723", "0230-8782", "9203-8128",
                                "6672-8727", "9230-9832", "0902-8373", "2337-9273",
                                "1802-3892", "8733-3878", "0730-8230", "8273-2782",
                                "0232-8982", "2309-0323", "2320-3903", "2369-9092",
                                "3232-7883", "2489-2398", "2392-9842", "9232-9044",
                                "4489-3329", "0090-0339", "9503-9923", "8232-3983",
                                "2323-9893", "9692-3904", "2319-0934", "9200-9592",
                                "2232-3909", "0002-3382", "2838-7283", "2380-9243",
                                "2329-0239", "2609-0912", "2300-9309", "2302-9201",
                                "2330-2070", "2179-2880", "2390-1307", "0402-9002",
                                "3242-7783", "2339-2388", "2192-9862", "9732-9144",
                                "4589-3309", "1090-0319", "9000-9023", "8132-3883",
                                "2823-9863", "9542-3804", "2509-0834", "9202-9792",
                                "2132-3919", "0502-3482", "2878-9083", "2359-1283",
                                "2301-0279", "2379-0903", "2709-9379", "2305-9102",
                                "2190-2790", "2289-2399", "2090-1309", "0862-9042",
                                "9283-9932", "2199-2898", "1398-8233", "2189-9233"};
    //
    public static void main(String[] args) {
        promptLab.setFont(new Font(getFontType, Font.BOLD, 10));
        promptLab.setForeground(Color.RED);
        //
        resWizard = new CBTSystemServerVersion();
        Dimension frame = resWizard.getToolkit().getScreenSize();
        ...
        resWizard.setIconImage(
                Toolkit.getDefaultToolkit().getImage("reflection.gif"));
        //
        insertPin("update schoolprofile "
        ...
        //
        if(getNumberOfPinDetails("select * from licences") == 0) {
            insertPin("insert into licences "
                + "values ('20" + licenceYear + "', "
                        + "'00000000')");
            //
            if (getNumberOfPinDetails("select * from schoolprofile") == 0) {
                insertPin("insert into schoolprofile "
                        + "values ('nil', "
                                + "'nil', "
                                + "'nil', "
                                + "'nil', "
        ...
        else if(getPinDetail("select licenceyear from licences").
                equalsIgnoreCase("20" + licenceYear)) {
            resWizard.setVisible(true);
            //
            if (getNumberOfPinDetails("select * from schoolprofile") == 0) {
                insertPin("insert into schoolprofile "
            ...
            if (!getPinDetail("select licenceyear from licences").
                    equalsIgnoreCase("20" + licenceYear)) {
                //
                insertPin("update schoolprofile "
                        + "set dataname = 'nil'");
                //
                int rep = ((int) (pinList.length * Math.random() + 1) - 1);
                insertPin("update licences "
                        + "set confirmpin = '" + pinList[rep] + "'");
                resWizard.setVisible(false);
                //request for comfirm pin
                String getYear = getPinDetail("select confirmpin from licences");
                getYear = getYear.substring(0, getYear.indexOf("-"));
                //
                reQuest = new reQuestionDialog(getYear); 
                reQuest.setSize(250, 400);
                reQuest.setTitle(titleText + " - key Wizard");
                Dimension frame1 = reQuest.getToolkit().getScreenSize();
                int height1 = reQuest.getHeight(),
                        width1 = reQuest.getWidth();
                reQuest.setLocation((frame1.width - width1) * 3 / 6,
                        (frame1.height - height1) / 2);
                reQuest.setVisible(true);
            }
        }
    }
    //
    static class reQuestionDialog extends JDialog {
        //
        JPasswordField entryPassField = new JPasswordField(20);
        JTextField reqField = new JTextField(10),
                mainCodeField = new JTextField(10);
        //
        JLabel reqLab = new JLabel("Request Code: ", JLabel.RIGHT),
                mainCodeLab = new JLabel("Maintenance Code: ", JLabel.RIGHT), 
                entryPassLab = new JLabel(" Activation Code");
        JPanel reqPanel = new JPanel();
        //
        public reQuestionDialog(String rCode) {
            //
            reqLab.setFont(new Font(getFontType, Font.BOLD, 10));
            reqLab.setForeground(Color.RED);
            mainCodeLab.setFont(new Font(getFontType, Font.BOLD, 10));
            mainCodeLab.setForeground(Color.RED);
            reqField.setFont(new Font(getFontType, Font.PLAIN, 12));
            reqField.setForeground(Color.BLACK);
            reqField.setBorder(BorderFactory.createEtchedBorder());
            reqField.setText(rCode);
            reqField.setEditable(false);
            entryPassLab.setFont(new Font(getFontType, Font.PLAIN, 12));
            entryPassLab.setForeground(Color.BLUE);
            mainCodeField.setFont(new Font(getFontType, Font.PLAIN, 12));
            mainCodeField.setForeground(Color.BLACK);
            mainCodeField.setBorder(BorderFactory.createEtchedBorder());
            entryPassField.setFont(new Font(getFontType, Font.PLAIN, 12));
            entryPassField.setForeground(Color.BLACK);
            entryPassField.setBorder(BorderFactory.createEtchedBorder());
            entryPassField.setEchoChar('o');
            //
            JPanel entryPassFieldPanel = new JPanel();
            entryPassFieldPanel.setBackground(Color.WHITE);
            entryPassFieldPanel.setLayout(new GridLayout(2, 1, 0, 0));
            entryPassFieldPanel.add(entryPassLab);
            entryPassFieldPanel.add(entryPassField);
            //
            reqPanel.setLayout(new GridLayout(2, 2, 0, 0));
            reqPanel.setBorder(BorderFactory.createEtchedBorder());
            reqPanel.add(reqLab);
            reqPanel.add(reqField);
            reqPanel.add(mainCodeLab);
            reqPanel.add(mainCodeField);
            //
            JPanel entryPassReqPanel = new JPanel();
            entryPassReqPanel.setLayout(new BorderLayout());
            entryPassReqPanel.setBackground(Color.WHITE);
            entryPassReqPanel.add(new JLabel(new ImageIcon("images/serverlogo.jpg")), 
                    BorderLayout.CENTER);
            entryPassReqPanel.add(entryPassFieldPanel, BorderLayout.SOUTH);
            //
            setLayout(new BorderLayout());
            add(entryPassReqPanel, BorderLayout.CENTER);
            add(reqPanel, BorderLayout.SOUTH);
            validate();
            //
            mainCodeField.addActionListener(new passwordControl());
        }
        //
        class passwordControl implements ActionListener {
            
            public void actionPerformed(ActionEvent e) {
                if(e.getSource().equals(mainCodeField)) {
                    if(new String(entryPassField.getPassword()).
                            equals(getPasswordForCode)) {
                        //
                        for(int pos = 0; pos < pinList.length; pos++) {
                            if(pinList[pos].equalsIgnoreCase(reqField.getText())) {
                                mainCodeField.setText(pinList[pos]);
                                break;
                            }
                        }
                        //
                        ...
                        }catch(InterruptedException ererer){}
                        //
                        if (getPinDetail("select confirmpin from licences").
                                equalsIgnoreCase(mainCodeField.getText())) {
                            //
                            insertPin("update licences "
                                    + "set licenceyear = '20" + licenceYear + "'");
                            //
                            promptLab.setText("Please Click OK, While " + 
                                    titleText + " Reboots");
                            JOptionPane.showMessageDialog(null,
                                    promptLab,
                            ...
                            //
                            promptLab.setText("Technology Is Now, The Future Just Started.");
                            JOptionPane.showMessageDialog(null,
                                    promptLab,
                                    "My Evolution & History",
                                    JOptionPane.INFORMATION_MESSAGE,
                        ...
                        promptLab.setText("Entry Password Not Correct");
                        JOptionPane.showMessageDialog(null, 
                                promptLab, 
                                "My Evolution & History", 
                                JOptionPane.INFORMATION_MESSAGE,
    ...
    //
    static String[] getPopulateList(String query, int c) {
        String[] list = new String[c];
        int res = 0;
        Connection conn;
        Statement statement;
        ...
        try {
            ...
            if (!set.next()) {
                ...
                do {
                    row.addElement(getPinRow(set, data));
                    list[res] = row.get(res).toString().substring(1,
                            row.get(res).toString().length() - 1);
                    //
                    res++;
    ...
    //
    static int getNumberOfPinDetails(String query) {
        //method responsible for query the database
        Connection conn;
        Statement statement;
        ResultSet set;
    ...
    //
    static String getPinDetail(String query) { //method responsible for query the database
        Connection conn = null;
        Statement statement = null;
        ResultSet set = null;
        String rep = "";
    ...
    //
    public static Connection pinConnection() {
        Connection connection = null;
        String url = "jdbc:odbc:" + databaseName;
        try {
            Class.forName("sun.jdbc.odbc.JdbcOdbcDriver");
    ...
    //
    public static int insertPin(String query) {
        int res = 0;
        Connection connection = pinConnection();
        try {
            Statement statement = connection.createStatement();
            res = statement.executeUpdate(query);
            connection.commit();
    ...
    //
    public static Vector getPinRow(ResultSet rs, ResultSetMetaData data) throws SQLException {
        Vector currentRow = new Vector();
        for (int x = 1; x <= data.getColumnCount(); x++) {
            switch (data.getColumnType(x)) {
                case Types.VARCHAR:
